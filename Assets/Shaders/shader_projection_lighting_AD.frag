...
//light 1
	...
	result += ambient1 + 1 * (diffuse1 + specular1);
...
//light 2
	...
	result += ambient2 + 1 * (diffuse2 + specular2);
...
//light 3
	...
	result +=  ambient3 + 0.5 * (diffuse3 + specular3);
...
//texturing
	...
	vertColour = (vec4(result,1.0) * textureColour);
